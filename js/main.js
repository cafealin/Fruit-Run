...
WebFontConfig = {
	...
	active: function () {
		game.time.events.add(Phaser.Timer.SECOND, this);
	},
...
Main.prototype = {
	...
	create: function () {
		...
		var bgMain = game.add.sprite(0, 0,'bgMain');
		bgMain.height = game.height;
		bgMain.width = game.width;
		bgMain.smoothed = false;
	...
	upInputIsActive: function (duration) {
		...
		isActive = this.input.keyboard.downDuration(Phaser.Pointer.LEFT_BUTTON, duration);
	...
	upInputReleased: function () {
		...
		released = this.input.keyboard.upDuration(Phaser.Pointer.LEFT_BUTTON);
	...
	createPlayer: function () {
		...
		this.player.animations.play('walk', 22, true);

	},

	createScore: function () {

		var scoreFont = "70px Carter One";
		...
		this.highScore = this.game.add.text(this.game.world.centerX * 1.6, 70, "0", {
			font: scoreFont,
			fill: "#000"
		});
	...
	incrementScore: function () {
		...
		this.game.world.bringToTop(this.scoreLabel);
		text = this.highScore.setText("High Score: " + window.localStorage.getItem('HighScore'));
